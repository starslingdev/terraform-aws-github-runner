...
| <a name="input_tenant_table_name"></a> [tenant\_table\_name](#input\_tenant\_table\_name) | DynamoDB table name for multi-tenant configuration. When set, enables per-tenant runner limits. | `string` | `null` | no |
